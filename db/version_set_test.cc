...
TEST_F(VersionStorageInfoTest, GetOverlappingInputs) {
  ...
  Add(1, 3U, {"d", 0, kTypeValue, 0}, {"e", kMaxSequenceNumber, kTypeValue, kMaxTimeStamp}, 1);
  Add(1, 4U, {"e", 0, kTypeValue, 0}, {"f", 0, kTypeValue, 0}, 1);
  ...
  ASSERT_EQ("1", GetOverlappingFiles(
      1, {"a", 0, kTypeValue, 0}, {"b", kMaxSequenceNumber, kTypeRangeDeletion, kMaxTimeStamp}));
  ASSERT_EQ("2", GetOverlappingFiles(
      1, {"b", kMaxSequenceNumber, kTypeValue, kMaxTimeStamp}, {"c", 0, kTypeValue, 0}));
  ASSERT_EQ("3,4", GetOverlappingFiles(
      1, {"d", 0, kTypeValue, 0}, {"e", 0, kTypeValue, 0}));
  ASSERT_EQ("3", GetOverlappingFiles(
      1, {"d", 0, kTypeValue, 0}, {"e", kMaxSequenceNumber, kTypeRangeDeletion, kMaxTimeStamp}));
  ASSERT_EQ("3,4", GetOverlappingFiles(
      1, {"e", kMaxSequenceNumber, kTypeValue, kMaxTimeStamp}, {"f", 0, kTypeValue, 0}));
  ASSERT_EQ("3,4", GetOverlappingFiles(
      1, {"e", 0, kTypeValue, 0}, {"f", 0, kTypeValue, 0}));
